...
export function InsufficientDataWarning({ visible, routeId }: InsufficientDataWarningProps) {
  ...
  return (
    ...
    >
      ...
      <span>
        {" "}
        A quantidade de pings disponíveis é muito baixa para calcular métricas confiáveis de
        regularidade. Consulte o painel de qualidade de dados para detalhes.
      </span>
    </div>
  );
}
